...
```
Here I see that there is one negative RBI.
...
The first epicycle was more or less done in the data cleaning stage. Now I need to build some models.  I will start with some histograms and bar graphs for all data. Not only this, but means and medians where applicable. I will try to see if any are skewed, and use a Poisson method to measure this.
