...
ggplot(data = women, aes(x= height, y = weight)) +
  ...
  geom_line(linetype = "dashed", color = "blue") +
  ggtitle("Scatterplot of women's height vs weight")
#This is a scatterplot where the lines have been added, and given a colour. There are various shaeps which can be chosen, as well as line types.
```
...
is.na(charvector1)
#a blank value does not count as NA.
```
