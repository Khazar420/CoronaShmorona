...
This shows us that with a ratio of F=20.02 the probability that this (or a result more extreme than this) would arise by change alone if the means were the same is extremely small.
